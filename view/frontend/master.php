        ...
        <div class="main">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="banner-left"><a href="#"><img src="public/frontend/banner13.jpg" alt=""></a>
                    ...
                    <div class="col-sm-5">
                        <div class="banner banner-double"><a href="#"><img alt="" src="public/frontend/banner10.jpg"></a></div>
                        <div class="banner banner-double"><a href="#"><img alt="" src="public/frontend/banner11.jpg" width="100%"></a></div>
                    </div>
                    <div class="col-sm-4">
                        <div class="banner"><a href="#"><img alt="" src="public/frontend/banner12.jpg"></a></div>
                    </div>
                </div><!-- /advertisement -->
                <div class="row">
                    <div class="col-sm-3 col-left">
                        <div class="timely">
                            ...
                            <div id="timely-owl" class="owl-container">
                                <?php include "controller/frontend/controller_hot_deals.php" ?>
                            </div>
                        </div><!-- /.timely -->
                        <div class="block">
                            ...
                            <div id="special-offer" class="owl-container">
                                <div class="owl">
                                    <div class='sepecialoffer-item item'>
                                        <?php include 'controller/frontend/controller_special.php' ?>
                                    ...
                                    <div class='sepecialoffer-item item'>
                                        <div class="item-inner first">
                                            <div class="images-container">
                                                <a href="h#" title="consequences" class="product-image">
                                                    <img src="public/frontend/item1.jpg" alt="consequences" />
                                                </a>
                                            </div>
                                        ...
                                        <div class="item-inner">
                                            <div class="images-container">
                                                <a href="#" title="Cras neque metus" class="product-image">
                                                    <img src="public/frontend/item1.jpg" alt="Cras neque metus" />
                                                </a>
                                            </div>
                                            <div class="des-container">
                                        ...
                                        <div class="item-inner ">
                                            <div class="images-container">
                                                ...
                                                <img src="public/frontend/item1.jpg" alt="Etiam gravida" />
                                                </a>
                                            </div>
                                            <div class="des-container">
                                        ...
                                        <div class="item-inner last">
                                            <div class="images-container">
                                                ...
                                                <img src="public/frontend/item1.jpg" alt="Donec non est" />
                                                </a>
                                            </div>
                                            <div class="des-container">
                                        ...
                                        <div class="item-inner first">
                                            <div class="images-container">
                                                <a href="#" title="pleasure rationally" class="product-image">
                                                    <img src="public/frontend/item1.jpg" alt="pleasure rationally" />
                                                </a>
                                            </div>
                                            <div class="des-container">
                                        ...
                                        <div class="item-inner ">
                                            <div class="images-container">
                                                <a href="#" title="Aliquam consequat" class="product-image">
                                                    <img src="public/frontend/item2.jpg" alt="Aliquam consequat" />
                                                </a>
                                            </div>
                                            <div class="des-container">
                                        ...
                                        <div class="item-inner ">
                                            <div class="images-container">
                                                <a href="#" title=" Donec ac tempus " class="product-image">
                                                    <img src="public/frontend/item3.png" alt=" Donec ac tempus " />
                                                </a>
                                            </div>
                                            <div class="des-container">
                                        ...
                                        <div class="item-inner last">
                                            <div class="images-container">
                                                <a href="#" title="occaecati cupiditate" class="product-image">
                                                    <img src="public/frontend/item1.jpg" alt="occaecati cupiditate" />
                                                </a>
                                            </div>
                                            <div class="des-container">
                    ...
                    <div class="col-sm-9 col-right">
                        ...
                        <div class="title-group1"><h2>Sản phầm mới</h2></div>
                        ...
                        <div class="newproductslider-container"> 
                            <div class="title-group1"><h2>Hàng mới về khuyến mãi</h2></div>
                            <div id="new-products" class="owl-container">
                                <div class="owl">
                                    <?php include "controller/frontend/controller_product_sale.php" ?>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-smc-7">
                                <div class="banner">
                                    <a href="#"><img alt="" src="public/frontend/item9.jpg" width="100%"></a>
                                </div>
                            </div>
                            <div class="col-smc-5">
                                <div class="banner">
                                    <a href="#"><img alt="" src="public/frontend/item10.jpg"></a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="title-group"><h2>Ngẫu nhiên</h2></div>
                                <div class="product-list">
                                    <?php include "controller/frontend/controller_randomproduct.php" ?>
                                </div><!-- /.product-list -->
                            </div>
                            <div class="col-sm-4">
                                <div class="title-group"><h2>Khuyến mãi khủng</h2></div>
                                <div class="product-list">
                                    <?php include "controller/frontend/controller_bestsaller.php" ?>
                            ...
                            <div class="col-sm-4">
                                <div class="title-group"><h2>Hot deals</h2></div>
                                <div class="product-list">
                                    <?php include "controller/frontend/controller_hotdeals.php" ?>
