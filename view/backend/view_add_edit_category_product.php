			...
			<!-- neu muon upload duoc file, phai co thuoc tinh enctype="multipart/form-data" -->
				<form method="post" enctype="multipart/form-data" action="<?php echo $form_action; ?>">
					...
					<div class="form-group">
						<div class="row">
							<div class="col-md-2 text-right">Tên danh mục</div>
							<div class="col-md-10">
<input type="text" name="c_name_category" value="<?php echo isset($arr->name_category_product)?$arr->name_category_product:""; ?>" required class="form-control">
							</div>
						</div>
					</div>
					<!-- end form group -->
