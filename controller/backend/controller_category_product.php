		...
		public function __construct(){
			...
			switch($act){
				case "delete":
					...
					$this->model->execute("delete from category_product where id_category_product=$id");
			...
			$total = $this->model->num_rows("select name_category_product from category_product");
			...
			//------------
			$arr = $this->model->get_all("select * from category_product order by id_category_product asc limit $from,$record_per_page");
			//load view
